...
## Important Notice
The provided implementation serves as a reference example, but actual deployment should be tailored to specific application requirements and optimized according to the use case. 
